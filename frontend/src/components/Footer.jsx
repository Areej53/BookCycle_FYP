  ...
  return (
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div className="footer-col"><h4>Contact</h4><ul><li><Link to="#"><span className="__cf_email__" data-cfemail="771f121b1b18371518181c140e141b1259071c">hello@bookcycle.com</span></Link></li><li><Link to="#">+92 300 1234567</Link></li><li><Link to="#">F-7, Islamabad</Link></li><li><Link to="#">Help Center</Link></li></ul></div>
      </div>
