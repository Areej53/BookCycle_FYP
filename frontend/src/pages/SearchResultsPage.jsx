...
<div className="search-hero">
  <div className="search-hero-inner">
    ...
    <h1>Results for: <em id="query-display">"…"</em></h1>
    <p className="search-hero-sub" id="result-summary">Searching…</p>
    <div className="search-wrap-hero">
      <div className="search-bar">
        <input type="text" id="search-inp" placeholder="Search by title, author, or category…" oninput="liveSearch()" onkeydown="if(event.key==='Enter')doSearch()"/>
...
<div className="browse-layout">
  ...
  <main className="main-col">
    <div className="sort-bar">
      <div className="result-count"><strong id="result-count">0</strong> results</div>
