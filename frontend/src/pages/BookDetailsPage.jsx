                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                                ...
                                {book.category === 'Notes' ? (
                                    <button 
                                        ...
                                        style={{ background: 'var(--primary)', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '12px', padding: '0 30px', height: '64px', border: 'none', color: '#fff', borderRadius: '32px', cursor: 'pointer', transition: 'all .2s', boxShadow: '0 12px 30px rgba(19,73,60,0.35)', fontSize: '1.1rem', fontWeight: 600 }}
                                    >
